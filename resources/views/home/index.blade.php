            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="hero-content" data-aos="fade-right" data-aos-delay="200">
                        ...
                        <p>A <strong>GrowFin</strong> é especialista em Business Process Outsourcing Financeiro, oferecendo
                            ...
                            contas, contas a pagar, contas a receber, conciliação bancária e de cartões, DRE, DFC e muito
                            mais.</p>
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
                    <div class="hero-image">
                        <img src="{{ asset('assets/img/logo-sem-fundo.png') }}" alt="BPO Financeiro"
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    <div class="about-content" data-aos="fade-right" data-aos-delay="200">
                        ...
                        <p class="lead">A <strong>GrowFin</strong> é uma empresa especializada em Business Process
                            Outsourcing
                            (BPO) Financeiro,
                            oferecendo soluções completas para outras empresas. Prestamos serviços de análise de contas,
                            contas a
                            pagar, contas a receber e conciliação bancária, de cartões e com IFood.</p>
                        <p>Nossa equipe altamente qualificada garante processos financeiros eficientes, precisos e em
                            conformidade
                ...
                <div class="col-lg-6">
                    <div class="about-image position-relative" data-aos="fade-left" data-aos-delay="200">
                        <img src="{{ asset('assets/img/paulo-helio-2.jpeg') }}" alt="BPO Financeiro"
            ...
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-7" data-aos="fade-left" data-aos-delay="300">
                    <div class="ceo-content">
                        ...
                        <p class="lead">Com vasta experiência em gestão financeira e business process outsourcing, Paulo
                            Hélio
                            lidera a <strong>GrowFin</strong> com foco em excelência, inovação e resultados para nossos
                            clientes.
                        </p>
                        ...
                        <div class="ceo-quote mt-4">
                            <div class="quote-content">
                                ...
                                <p>"Acreditamos que toda empresa merece ter processos financeiros eficientes e
                                    transparentes. Nossa
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="service-card">
                        ...
                        <p>Administração eficiente das contas a receber, otimizando o fluxo de caixa e garantindo o
                            recebimento em
                            dia.</p>
                        <div class="service-features">
            ...
            <div class="row mt-5 align-items-center">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-list-block">
                        ...
                        <p>Além dos serviços principais, oferecemos soluções complementares para uma gestão financeira
                            completa e
                            eficiente.</p>
                        ...
                        <div class="service-list">
                            <div class="service-list-item" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <div class="service-list-content">
                                    ...
                                    <p>Conciliação precisa de extratos bancários, garantindo que todos os lançamentos
                                        estejam corretos e
                                        atualizados.</p>
                                </div>
                            ...
                            <div class="service-list-item" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="service-list-content">
                                    ...
                                    <p>Conciliação completa de transações com cartões de crédito e débito, incluindo
                                        máquinas de cartão.
                                    </p>
                                </div>
                            </div><!-- End Service List Item -->
                            ...
                            <div class="service-list-item" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <div class="service-list-content">
                                    <h4>DRE e DFC</h4>
                                    <p>Elaboração de Demonstrativo de Resultado do Exercício (DRE) e Demonstrativo de Fluxo
                                        de Caixa
                                        (DFC).</p>
                                </div>
                            </div><!-- End Service List Item -->
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="service-card">
                        ...
                        <p>Conciliação especializada com a plataforma IFood, garantindo controle completo das vendas online.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="service-card">
                        ...
                        <p>Elaboração completa do Demonstrativo de Resultado do Exercício para análise de desempenho
                            financeiro.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="800">
                    <div class="service-card">
                        ...
                        <p>Emissão de Notas Fiscais e Boletos de cobrança, garantindo conformidade e agilidade nos
                            processos.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row align-items-center mb-5 content">
                <div class="col-lg-12" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-center lead">Oferecemos soluções completas e personalizadas para sua empresa, com
                        tecnologia
            ...
            <div class="row gy-4" data-aos="fade-up" data-aos-delay="300">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card h-100">
                        ...
                        <p>Já atendemos mais de 20 empresas de diversos segmentos, demonstrando nossa capacidade de
                            adaptação e
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card h-100">
                        ...
                        <p>Oferecemos mais de 12 serviços financeiros especializados, desde contas a pagar e receber até
                            DRE, DFC
                            ...
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="form-intro sticky-intro" data-aos="fade-right" data-aos-delay="200">
                                        ...
                                        <p>Nossa equipe especializada oferece soluções completas em BPO Financeiro,
                                            garantindo processos
                                            eficientes, precisos e em conformidade com as normas vigentes. Trabalhamos com
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <form method="post" action="javascript:void(0);" class="php-email-form"
                                        id="quote-form" novalidate>
                                        @csrf
                                        <div class="row g-3">
                                            <!-- 1. Nome -->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Qual o seu nome? <span
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label">Qual o seu sobrenome? <span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" name="lastname" id="lastname"
                                                        class="form-control" placeholder="Seu Sobrenome" required>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Qual o seu número de telefone? <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Qual o seu endereço de e-mail? <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Qual o faturamento da sua empresa? <span
                                                            class="text-danger">*</span></label>
                                                    <select name="company_size" id="company_size" class="form-control"
                                                        required>
                                                        <option value="">Selecione uma opção</option>
                                                        <option value="0_30">R$ 00,00 a R$ 30 mil</option>
                                                        <option value="30_50">R$ 30 mil a R$ 50 mil</option>
                                                        <option value="50_100">R$ 50 mil a R$ 100 mil</option>
                                                        <option value="100_500">R$ 100 mil a R$ 500 mil</option>
                                                        <option value="500_plus">Mais de R$ 500 mil</option>
                                                    </select>
                                                    <div class="invalid-feedback" id="company_size-error"
                                                        style="display: none;">
                                                        Por favor, selecione o faturamento da sua empresa.
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- 6. Setor de Atuação -->
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Qual o seu setor de atuação? <span
                                                            class="text-danger">*</span></label>
                                                    ...
                                                    <div class="invalid-feedback" id="sector-error"
                                                        style="display: none;">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group" id="financial_pain-group">
                                                    <label class="form-label">Qual é a maior dor hoje no seu
                                                        financeiro?</label>
                                                    <div class="invalid-feedback" id="financial_pain-error"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-square">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="financial_pain[]" value="falta-controle"
                                                                    id="pain-controle">
                                                                <label class="form-check-label" for="pain-controle">Falta
                                                                    de controle</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-square">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="financial_pain[]" value="falta-tempo"
                                                                    id="pain-tempo">
                                                                <label class="form-check-label" for="pain-tempo">Falta de
                                                                    tempo</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-square">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="financial_pain[]" value="falta-previsibilidade"
                                                                    id="pain-previsibilidade">
                                                                <label class="form-check-label"
                                                                    for="pain-previsibilidade">Falta de
                                                                    previsibilidade</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-square">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="financial_pain[]" value="retrabalho-operacional"
                                                                    id="pain-retrabalho">
                                                                <label class="form-check-label"
                                                                    for="pain-retrabalho">Retrabalho operacional</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-square">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="financial_pain[]" value="inadimplencia"
                                                                    id="pain-inadimplencia">
                                                                <label class="form-check-label"
                                                                    for="pain-inadimplencia">Inadimplência</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-square">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="financial_pain[]" value="desorganizacao"
                                                                    id="pain-desorganizacao">
                                                                <label class="form-check-label"
                                                                    for="pain-desorganizacao">Desorganização</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-square">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="financial_pain[]" value="multas-juros"
                                                                    id="pain-multas">
                                                                <label class="form-check-label"
                                                                    for="pain-multas">Pagamento de multas e juros por
                                                                    atraso</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group" id="financial_areas-group">
                                                    <label class="form-label">Quais áreas financeiras você precisa de
                                                        ajuda?</label>
                                                    <div class="invalid-feedback" id="financial_areas-error"
                                                        style="display: none; margin-bottom: 0.5rem;">
                                                        Por favor, selecione pelo menos uma opção.
                                                    </div>
                                                    <div class="checkbox-group row g-2">
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-square">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="financial_areas[]" value="contas-pagar"
                                                                    id="area-pagar">
                                                                <label class="form-check-label" for="area-pagar">Contas a
                                                                    pagar</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-square">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="financial_areas[]" value="contas-receber"
                                                                    id="area-receber">
                                                                <label class="form-check-label" for="area-receber">Contas
                                                                    a receber</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-square">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="financial_areas[]" value="conciliacao-bancaria"
                                                                    id="area-conciliacao">
                                                                <label class="form-check-label"
                                                                    for="area-conciliacao">Conciliação bancária</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-square">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="financial_areas[]" value="fluxo-caixa"
                                                                    id="area-fluxo">
                                                                <label class="form-check-label" for="area-fluxo">Fluxo de
                                                                    caixa</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-check checkbox-square">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="financial_areas[]" value="previsao-financeira"
                                                                    id="area-previsao">
                                                                <label class="form-check-label"
                                                                    for="area-previsao">Previsão financeira</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Você possui previsibilidade de fluxo de caixa
                                                        dos próximos 30 dias? <span class="text-danger">*</span></label>
                                                    <select name="cashflow_predictability" id="cashflow_predictability"
                                                    ...
                                                    <div class="invalid-feedback" id="cashflow_predictability-error"
                                                        style="display: none;">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label class="form-label">Em que nível você considera a urgência de
                                                        organizar seu financeiro? <span
                                                            class="text-danger">*</span></label>
                                                    <select name="urgency_level" id="urgency_level" class="form-control"
                                                        required>
                                                        <option value="">Selecione uma opção</option>
                                                        <option value="urgente">Preciso resolver urgente</option>
                                                        <option value="30-dias">Quero resolver nos próximos 30 dias
                                                        </option>
                                                        <option value="avaliando">Estou avaliando opções</option>
                                                    </select>
                                                    <div class="invalid-feedback" id="urgency_level-error"
                                                        style="display: none;">
                                                        Por favor, selecione uma opção.
                                                    </div>
                                                </div>
...
@section('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (stickyIntro && window.innerWidth >= 992) {
                ...
                containers.forEach(container => {
                    if (container) {
                        ...
                        if (style.overflow === 'hidden' || style.overflowY === 'hidden' || style
                            .overflowX === 'hidden') {
            ...
            const requiredInputs = ['name', 'lastname', 'company_size', 'sector', 'cashflow_predictability',
                'urgency_level'
            ];
            ...
            if (form) {
                ...
                function validateAllFields() {
                    ...
                    const financialAreasCheckboxes = form.querySelectorAll(
                        'input[name="financial_areas[]"]:checked');
                    ...
                    // 11. Validação do reCAPTCHA (só exige quando o widget existe, ex.: em produção; em local fica oculto)
                    const recaptchaWidget = document.getElementById('recaptcha-widget');
                    if (recaptchaWidget) {
                ...
                form.addEventListener('submit', function(e) {
                    ...
                    if (!validation.isValid) {
                        ...
                        if (errorMessage) {
                            errorMessage.innerHTML =
                                'Por favor, preencha todos os campos obrigatórios indicados.';
                        ...
                        if (validation.firstErrorField) {
                            ...
                            if (validation.firstErrorField.tagName === 'INPUT' || validation.firstErrorField
                                .tagName === 'SELECT') {
                    ...
                    // Verificar reCAPTCHA antes de enviar (só quando o widget existe; em local não existe)
                    const recaptchaWidgetSubmit = document.getElementById('recaptcha-widget');
                    let recaptchaResponse = '';
                    if (recaptchaWidgetSubmit) {
                        try {
                            if (typeof grecaptcha !== 'undefined') {
                                recaptchaResponse = grecaptcha.getResponse();
                            }
                        ...
                        if (!recaptchaResponse || recaptchaResponse === '') {
                            ...
                            const recaptchaError = document.getElementById('recaptcha-error');
                            if (recaptchaError) recaptchaError.style.display = 'block';
                            recaptchaWidgetSubmit.style.border = '2px solid #dc3545';
                            recaptchaWidgetSubmit.style.borderRadius = '4px';
                            recaptchaWidgetSubmit.style.padding = '5px';
                            recaptchaWidgetSubmit.scrollIntoView({
                                behavior: 'smooth',
                                block: 'center'
                            });
                            return;
                    ...
                    if (!csrfToken) {
                        ...
                        if (errorMessage) {
                            errorMessage.innerHTML =
                                'Erro: Token de segurança não encontrado. Por favor, recarregue a página.';
                            errorMessage.style.display = 'block';
                        }
                        return;
                    }
                        ...
                        .then(response => {
                            if (!response.ok) {
                                return response.json().then(data => {
                                    ...
                                    if (response.status === 419 || data.message?.includes(
                                            'CSRF') || data.message?.includes('token')) {
                                        throw new Error(
                                            'Sua sessão expirou. Por favor, recarregue a página e tente novamente.'
                                        );
                                    }
